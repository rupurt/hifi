...
export const liquidThemeMaterials: Readonly<Record<LiquidThemeName, LiquidMaterial>> = {
  ...
  tinted: {
    ...
    grammar: 'liquid',
    ior: 1.5,
    name: 'Amethyst tinted glass',
    opacity: 0.88,
    specularOpacity: 0.76,
    specularSharpness: 2.6,
    specularStrength: 1.1,
    surfaceProfile: 'convex',
    thickness: 34,
    tint: { r: 0.48, g: 0.24, b: 0.96, a: 0.38 },
    version: 1,
  },
  frosted: {
    bezelWidth: 38,
  ...
  prismatic: {
    ...
    blur: 4,
    cornerRadius: 28,
    cornerSmoothing: 0.32,
    contentDepth: 36,
    contentIor: 1.58,
    dispersion: 0.055,
    displacementBlur: 8,
    displacementFactor: 1.32,
    grammar: 'liquid',
    ior: 1.58,
    name: 'Frozen spectrum glass',
    opacity: 0.86,
    specularOpacity: 0.82,
    specularSharpness: 2.2,
    specularStrength: 1.3,
    surfaceProfile: 'convex',
    thickness: 36,
    tint: { r: 0.72, g: 0.9, b: 1, a: 0.12 },
    version: 1,
  },
  smoked: {
    bezelWidth: 40,
    ...
    surfaceProfile: 'lip',
    thickness: 42,
    tint: { r: 0.18, g: 0.22, b: 0.3, a: 0.34 },
    version: 1,
  },
}
